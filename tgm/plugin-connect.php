...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'               => 'contact-form-7.4.5.1', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/lib/plugins/contact-form-7.4.5.1.zip', // The plugin source.
