<?php
/**
 * meyer functions and definitions.
 *
...
function meyer_setup() {
	 ...
	 * If you're building a theme based on meyer, use a find and replace
	 * to change 'meyer' to the name of your theme in all the template files.
	 */
...
add_action( 'wp_enqueue_scripts', 'meyer_scripts' );
